...
import { useGetSmallBusiness } from '../../../../hooks/useHome'
...
function SmallBusinessCard() {
	const { data } = useGetSmallBusiness()
			...
			<ResponsiveContainer width='100%' height={260}>
				...
				>
					...
					<Legend
						...
						align='center'
						wrapperStyle={{ fontSize: 12, paddingTop: 10, paddingBottom: 10 }}
